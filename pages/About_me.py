...
with col1:
    st.markdown("""
            ...
            """)
with col2:
    components.html('<blockquote class="twitter-tweet"><p lang="es" dir="ltr">SaveYourLife es una pagina que usa Inteligencia Artificial para la predicción de tumores cerebrales mediante imágenes de resonancia magnética<a href="https://t.co/H4pcDDkqg2">https://t.co/H4pcDDkqg2</a></p>&mdash; SaveYourLife (@IabdMaster) <a href="https://twitter.com/IabdMaster/status/1634998263391866880?ref_src=twsrc%5Etfw">March 12, 2023</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>',height=420,width=350)
