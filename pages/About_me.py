...
with col1:
    st.markdown("""
            ...
            """)
with col2:
    components.html('<blockquote class="twitter-tweet"><p lang="es" dir="ltr">SaveYourLife es una pagina que usa Inteligencia Artificial para la predicción de tumores cerebrales mediante imágenes de resonancia magnética<a href="https://t.co/ebvcGxJY87">https://t.co/ebvcGxJY87</a> <a href="https://t.co/dx11NzRFxO">pic.twitter.com/dx11NzRFxO</a></p>&mdash; SaveYourLife (@IabdMaster) <a href="https://twitter.com/IabdMaster/status/1635032646136004608?ref_src=twsrc%5Etfw">March 12, 2023</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>',height=490,width=370)
