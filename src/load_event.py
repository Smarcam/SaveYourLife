...
def image_clickable(image_path, target_url):
    ...
    clickable_image = f'<a href="{target_url}" target="_self"><img src="data:image/png;base64,{b64encode(image).decode()}" style="width: 15%; object-fit: cover; object-position: bottom;"></a>'
